...
def get_mean_price_comp(comp) -> dict:
    ...
    result = json.loads(completion.choices[0].message.content)["resultats"] # Récupération du resultat
    ...
    price_list = [a["price"][0] for a in annonces if a["list_id"] in id_valides]
...
for i in range(10):
    print(get_mean_price_comp("RTX 4090"))

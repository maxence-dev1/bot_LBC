...
def get_build_id():
    ...
    response = requests.get(
        "https://www.leboncoin.fr/", headers={"User-Agent": os.environ["USER_AGENT"], "Cookie": os.environ["COOKIE"]}
    )
